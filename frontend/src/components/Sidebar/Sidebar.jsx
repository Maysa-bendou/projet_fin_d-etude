...
const menuItems = [
  { icon: MdDashboard, label: "Dashboard",    path: "/app" },
  { icon: MdAddCircle, label: "Créer Ticket", path: "/app/create-ticket" },
  { icon: FaTicketAlt, label: "Mes Tickets",  path: "/app/mes-tickets" },
  { icon: MdHistory,   label: "Historique",   path: "/app/historique" },
  { icon: MdPerson,    label: "Profil",       path: "/app/profile" },
];
