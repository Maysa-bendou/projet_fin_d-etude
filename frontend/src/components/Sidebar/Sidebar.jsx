...
import { MdDashboard, MdAddCircle, MdPerson, MdLogout } from "react-icons/md";
import { FaTicketAlt } from "react-icons/fa";

const menuItems = [
  { icon: MdDashboard, label: "Dashboard",     path: "/employee" },
  { icon: MdAddCircle, label: "Créer Ticket",  path: "/employee/create-ticket" },
  { icon: FaTicketAlt, label: "Mes Tickets",   path: "/employee/mes-tickets" },
  { icon: MdPerson,    label: "Profil",        path: "/employee/profile" },
];
