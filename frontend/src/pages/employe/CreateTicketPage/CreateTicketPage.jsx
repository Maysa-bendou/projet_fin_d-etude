...
const IMPACT_OPTIONS = [
  ...
  { value: "medium", label: "Un service" },
  { value: "high",   label: "Entreprise" },
];
const URGENCY_OPTIONS = [
  { value: "low",    label: "Peut travailler" },
  { value: "medium", label: "Partiellement bloqué" },
  { value: "high",   label: "Complètement bloqué" },
];
...
const Label = ({ children, required, missing }) => (
  <label style={{ display: "block", fontSize: 12, fontWeight: 600, letterSpacing: "0.3px", textTransform: "uppercase", marginBottom: 7, color: missing ? "#dc2626" : "#64748b" }}>
    ...
    {missing && <span style={{ marginLeft: 6, fontWeight: 500, textTransform: "none", fontSize: 11 }}>— champ requis</span>}
  </label>
);
      ...
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, background: "#f5f0e8" }}>
        <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #d9d4cc", padding: "40px 36px", maxWidth: 440, width: "100%", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 13, color: "#94a3b8", marginBottom: 28 }}>
            Ticket <span style={{ fontFamily: "monospace", background: "#f1f5f9", padding: "2px 8px", borderRadius: 6, color: "#475569" }}>#{success.id}</span> soumis.
          </p>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #d9d4cc", padding: "32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <SectionTitle>Détails de la demande</SectionTitle>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                ...
                <div ref={fieldRefs.category}>
                  <Label required missing={isMissing("category")}>Catégorie</Label>
                  <div style={{ position: "relative" }}>
              ...
              <div ref={fieldRefs.title}>
                <Label required missing={isMissing("title")}>Titre</Label>
              ...
              <div ref={fieldRefs.description} style={{ flex: 1 }}>
                <Label required missing={isMissing("description")}>Description détaillée</Label>
                <textarea name="description" value={form.description} onChange={handleChange} rows={8}
                  placeholder="Décrivez clairement votre problème (contexte, actions réalisées, message d'erreur)..."
            ...
            {/* ── DROITE ── */}
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <SectionTitle>Évaluation de l'impact</SectionTitle>

              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                <div ref={fieldRefs.impact}>
                  <Label required missing={isMissing("impact")}>Impact</Label>
                  <div style={{ position: "relative" }}>
                ...
                <div ref={fieldRefs.urgency}>
                  <Label required missing={isMissing("urgency")}>Urgence</Label>
                  <div style={{ position: "relative" }}>
