...
const LevelBadge = ({ config, value, label }) => {
  ...
  if (!cfg) return <span style={{ fontSize: 13, color: "#6b7280" }}>{display || "—"}</span>;
  return (
            ...
            <div style={{ background: "#fff", border: "1px solid #d9d4cc", borderRadius: 16, overflow: "hidden" }}>
              ...
              <div style={{ padding: "14px 22px", borderBottom: "1px solid #e8e2d9" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8 }}>
                  {[
                    { icon: <MdFlag style={{ fontSize: 13 }} />,          label: t("ticketDetail.cols.priority"),  node: <Pill config={PRIORITY_CONFIG} value={tk.priority} label={t(`priority.${tk.priority}`, { ns: "common" })} /> },
                    { icon: <MdCategory style={{ fontSize: 13 }} />,       label: t("ticketDetail.cols.category"),  node: <Pill config={CATEGORY_CONFIG} value={tk.category} label={t(`category.${tk.category}`, { ns: "common" })} /> },
                ...
                <div style={{ padding: "12px 22px", borderBottom: "1px solid #e8e2d9" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                      ...
                      {sla.mode === "paused" && (
                        <span style={{ fontSize: 10, fontWeight: 700, color: "#7c3aed", background: "#ede9fe", padding: "2px 7px", borderRadius: 99 }}>{t("ticketDetail.sla.paused")}</span>
                      )}
                      {sla.mode === "terminal" && (
                        <span style={{ fontSize: 10, fontWeight: 700, color: "#64748b", background: "#f1f5f9", padding: "2px 7px", borderRadius: 99 }}>{t("ticketDetail.sla.closed")}</span>
                      )}
                    </div>
              ...
              <div style={{ padding: "14px 22px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
                <div>
                  ...
                  {isAssigned ? (
                    ...
                    <span style={{ fontSize: 13, fontWeight: 600, color: "#1e3a8a", fontStyle: "italic" }}>{t("ticketsService.unassigned")}</span>
                  )}
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            ...
                            <div>
                              ...
                              <p style={{ fontSize: 11, color: "#94a3b8", margin: 0 }}>
                                {tech.job_title || t("ticketDetail.profile.position")}
                              </p>
                            </div>
                          </div>
                          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        ...
                        {isSelected && (
                          <div style={{ background: "#eff6ff", borderTop: "1px solid #bfdbfe", padding: "14px 22px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap", animation: "fadeIn 0.15s ease" }}>
                            <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
                              {[
                                { label: t("ticketDetail.profile.email"),    value: tech.email },
                                { label: t("ticketDetail.profile.contact"),  value: tech.phone },
                                { label: t("ticketDetail.profile.office"),   value: tech.office },
                            ...
                            >
                             {isAssigned ? t("ticketDetail.btn.confirmModify") : t("ticketDetail.btn.assign")}
                            </button>
                          </div>
                        )}
                      </li>
