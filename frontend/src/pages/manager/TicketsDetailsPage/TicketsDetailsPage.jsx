...
return { mode: "paused", text: t("ticketDetail.sla.frozen", { h, m }), pct: Math.min(100, (frozen / window) * 100) };
  ...
  // ── LevelBadge — dot colour from config, label from translateKey ──────────
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', gap: 16, alignItems: 'start' }}>
          ...
          <div style={{ background: '#fff', border: '1px solid #d9d4cc', borderRadius: 16, overflow: 'hidden' }}>
            ...
            <div style={{ padding: '16px 22px', borderBottom: '1px solid #e8e2d9', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16 }}>
              ...
              {/* Status — translated via STATUS_KEYS → common.json status.* */}
              <Pill
                ...
                {[
                  {
                    ...
                    // Priority — translated via PRIORITY_KEYS → common.json priority.*
                  ...
                  },
                  {
                    ...
                    // Category — translated via CATEGORY_KEYS → common.json category.*
                  ...
                  },
                  {
                    ...
                    // Service — free DB value, not translated
                  ...
                  },
                  {
                    ...
                    // Impact — translated via IMPACT_KEYS → common.json impact.*
                  ...
                  },
                  {
                    ...
                    // Urgency — translated via URGENCY_KEYS → common.json urgency.*
